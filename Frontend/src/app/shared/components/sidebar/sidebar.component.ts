  ...
  template: `
    ...
    >
      ...
      <div class="px-3 py-4 border-t border-slate-800">
        <a
          routerLink="/recruiter/jobs/new"
          (click)="layout.closeSidebar()"
          class="flex items-center gap-3 rounded-xl border border-indigo-500/30
                 bg-indigo-500/10 px-3 py-3 transition-colors
                 hover:border-indigo-400/50 hover:bg-indigo-500/15">
          ...
          <div class="flex-1 min-w-0">
            <p class="text-sm font-semibold text-white">Post a Job</p>
            <p class="text-xs text-slate-400">Create a new opening</p>
          </div>
          <svg class="h-4 w-4 flex-shrink-0 text-indigo-300"
