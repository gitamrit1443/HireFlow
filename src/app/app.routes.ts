...
export const routes: Routes = [
...

  {
    path: 'recruiter',
    loadComponent: () =>
      import('./shared/layout/recruiter-layout/recruiter-layout.component')
        .then(m => m.RecruiterLayoutComponent),
    children: [
      {
        path: 'dashboard',
        loadComponent: () =>
          import('./features/recruiter/dashboard/dashboard.component')
      ...
      },
      {
        path: 'jobs',
        loadComponent: () =>
          import('./features/recruiter/jobs/jobs.component')
      ...
      },
      {
        path: 'jobs/new',
        loadComponent: () =>
          import('./features/recruiter/jobs/job-form.component')
      ...
      },
      {
        path: 'candidates',
        loadComponent: () =>
          import('./features/recruiter/candidates/candidates.component')
      ...
      },
      {
        path: 'candidates/:id',
        loadComponent: () =>
          import('./features/recruiter/candidates/candidate-detail.component')
      ...
      },
      {
        path: 'pipeline',
        loadComponent: () =>
          import('./features/recruiter/pipeline/pipeline.component')
      ...
      },
      {
        path: 'interviews',
        loadComponent: () =>
          import('./features/recruiter/interviews/interviews.component')
      ...
      },
      {
        path: 'analytics',
        loadComponent: () =>
          import('./features/recruiter/analytics/analytics.component')
      ...
      },
      {
        path: 'settings',
        loadComponent: () =>
          import('./features/recruiter/settings/settings.component')
