    ...
    <div class="min-h-screen bg-gradient-to-br from-slate-50 via-slate-100 to-indigo-50
      ...
      <div class="w-full max-w-sm">
        ...
        <div class="text-center mb-8">
          ...
          <h1 class="text-2xl font-bold text-slate-900 tracking-tight">Request Access</h1>
          <p class="text-sm text-slate-500 mt-1">
            Your workspace admin will approve your request
          </p>
        </div>
        ...
        @if (!submitted()) {
          ...
          <div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-8 text-center">
            ...
            <h2 class="text-lg font-bold text-slate-900 mb-2">Request Submitted!</h2>
            <p class="text-sm text-slate-500 leading-relaxed mb-5">
              Your admin will review your request and send login credentials
              to <strong class="text-slate-700">{{ signupForm.get('email')?.value }}</strong>
              within 24 hours.
            </p>
