            ...
            <form [formGroup]="scheduleForm" (ngSubmit)="submitSchedule()" class="p-6 space-y-4">
              ...
              <div>
                ...
                <select formControlName="candidateId"
                  ...
                  @for (c of mockData.candidates; track c.id) {
...
export class InterviewsComponent {
  ...
  submitSchedule(): void {
    ...
    const candidate = this.mockData.getCandidateById(v.candidateId)!;
    ...
    setTimeout(() => {
      this.interviewService.add(newInterview);
  ...
  submitFeedback(): void {
    ...
    setTimeout(() => {
      this.interviewService.submitFeedback(iv.id, feedback);
