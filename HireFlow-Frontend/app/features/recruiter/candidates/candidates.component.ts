...
export class CandidatesComponent {
  ...
  readonly allCandidates = this.mockData.candidates;
  ...
  readonly hasActiveFilters = computed(() =>
    !!this.searchQuery || !!this.stageFilter || !!this.deptFilter
  );

  readonly filteredAndSorted = computed(() => {
    const q = this.searchQuery.toLowerCase();

    let result = this.allCandidates.filter(c => {
  ...
  readonly departments = [...new Set(this.allCandidates.map(c => c.department))];
